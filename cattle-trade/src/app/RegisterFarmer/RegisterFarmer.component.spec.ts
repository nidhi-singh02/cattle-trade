...
describe('RegisterFarmerComponent', () => {
  ...
  let mockRegisterFarmerService;
  let mockDataService

  beforeEach(async(() => {

    mockRegisterFarmerService = sinon.createStubInstance(RegisterFarmerService);
    mockRegisterFarmerService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: RegisterFarmerService, useValue: mockRegisterFarmerService },
