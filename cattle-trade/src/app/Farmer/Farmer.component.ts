...
export class FarmerComponent implements OnInit {
  ...
  allCattle = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.cattle.trading.Farmer',
      'allCattle': this.allCattle.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceFarmer.updateParticipant(form.get('userId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.allCattle) {
        formObject.allCattle = result.allCattle;
      } else {
        formObject.allCattle = null;
      }
